...
class test
{
  public static void main(String[] args)
  {
    ...
    System.out.println("Enter Account userbalance :- ");
    double d1 = sc.nextDouble();
    System.out.println("Enter Account interestrate :- ");
    double d2 = sc.nextDouble();
    
    BankAccount b1 = new BankAccount(number,name,d1,d2);
    b1.display();
