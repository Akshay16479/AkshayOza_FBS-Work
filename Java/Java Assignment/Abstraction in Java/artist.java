...
abstract class Artist {
			...
			{
				return "Artist Name : " + this.name + "Artist Age  : " + this.age + "Field  : " + this.field + "\n" ;
			}
		...
		class Actor extends Artist {
	      ...
	      System.out.println("The actor performs in movies");
		    ...
		    public String toString()
			{
				return super.toString() + "Movie Type  : " + this.movieType +  "\n" ;
			}
		...
		class TestArtist {
		    ...
		    public static void main(String[] args) {
		        ...
		        a = new Singer("abc",21,"general","classical");
		        System.out.println(a.toString());
		        a.perform();
		        System.out.println();

		        a = new Actor("pqr",22,"nostalegia","Drama");
		        System.out.println(a.toString());
		        a.perform();
